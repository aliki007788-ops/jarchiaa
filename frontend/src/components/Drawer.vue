  ...
  <div class="drawer" :class="{ open: isOpen }">
    ...
    <div class="drawer-items">
      ...
      <template v-if="userRole === 'business'">
        ...
        <div class="drawer-item" @click="navigateTo('/business/create-ad')">
      ...
      <template v-if="userRole === 'admin'">
        ...
        <div class="drawer-item" @click="navigateTo('/admin/users')">
          <i class="fas fa-users"></i>
          <span>مدیریت کاربران</span>
        </div>
        <div class="drawer-item" @click="navigateTo('/admin/businesses')">
          <i class="fas fa-store"></i>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const userName = computed(() => localStorage.getItem('userName') || 'کاربر جارچیا')
    ...
    const navigateTo = (path) => {
      router.push(path)
      emit('close') // بستن منو بعد از کلیک
    }
